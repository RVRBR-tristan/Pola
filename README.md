...
- **Cadres photoréalistes** : Polaroid 600 blanc / vieilli / noir synthétisés (fibre du papier par bruit multi-octaves, fenêtre embossée, usure des bords, auréoles) ; Instax Mini d'après une vraie texture scannée (`assets/instax-frame.jpg`). Géométries d'après les formats réels.
