...
- **Export** : jeu de fichiers PNG haute résolution par tirage, identique partout dans l'app (bouton Télécharger de l'éditeur comme export de masse de la galerie) — l'original filtré non recadré (`-original`), le polaroid encadré, et la composition 2160 × 2700 (`-4-5`) uniquement si un fond 4:5 est activé. Chaque fichier est téléchargé individuellement, avec un nom horodaté portant un jeton unique — aucun écrasement, même en ré-exportant la même photo.
