...
- **Navigation par swipe** : en édition, un glissement horizontal sur l'aperçu passe à la photo précédente / suivante de la galerie (gauche → suivante, droite → précédente), sans repasser par la galerie. Hors mode Recadrer, où le glissement déplace le cadrage.
