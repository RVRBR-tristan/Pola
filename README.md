...
- **Galerie** : chaque photo est conservée localement (IndexedDB) avec sa source pleine résolution et ses réglages — rééditable à tout moment ; sélection unitaire ou de masse, suppression avec confirmation, et export de masse qui re-rend chaque tirage en pleine résolution selon ses propres réglages (film, cadre, recadrage, light leak, format polaroid ou 4:5) puis le télécharge **individuellement** dans le dossier Téléchargements de l'appareil — repris automatiquement par la sauvegarde Google Photos.
